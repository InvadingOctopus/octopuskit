...
//  🔶 STEP 2: The view controller for the SpriteKit view (SKView) that displays your game.
//
//  Creating a subclass of OctopusViewController is not necessary for an OctopusKit, but complex games may require some view controller customization.
//
...
final class MyGameViewController: OctopusViewController {
    ...
    override func viewDidLoad() {
        ...
        // 🔶 STEP 2.1: You may customize some screen-related settings here, such as the device orientations allowed in your game and status bar visibility etc.
