...
//  🔶 STEP 2: The OctopusGameCoordinator is the master coordinator for an OctopusKit game.
//
...
//
//  Each OctopusGameState has a scene and UI overlay associated with it; scenes present the content for each state.
//
//  Creating a subclass of OctopusGameCoordinator is not necessary for basic OctopusKit projects so you may simply use OctopusGameCoordinator(states:initialStateClass:)
//
//  Complex games may require custom coordinators to manage different kinds of global state and external connections.

import OctopusKit

final class MyGameCoordinator: OctopusGameCoordinator {
