...
/// Executes a supplied `SKNode` generating closure and draws its output inside the frame of an `SpriteKitComponent`, at random positions generated by a `RandomizationComponent`.
///
/// **Dependencies:** `RandomizationComponent`, `SpriteKitComponent`
