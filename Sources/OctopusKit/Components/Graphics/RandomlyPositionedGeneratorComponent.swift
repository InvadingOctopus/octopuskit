...
/// Executes a supplied `SKNode` generating closure and draws its output inside the frame of an `SpriteKitComponent`, at random positions generated by a `RandomizationSourceComponent`.
///
/// **Dependencies:** `RandomizationSourceComponent`, `SpriteKitComponent`
public final class RandomlyPositionedGeneratorComponent: SpriteKitAttachmentComponent<SKNode> {
    ...
    /// - Parameter position: The random position that the returned node will be placed in, generated by the entity's `RandomizationSourceComponent`.
