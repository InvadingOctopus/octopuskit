...
public final class KeyboardEventComponent: OKComponent, OKUpdatableComponent {
    ...
    public override func didAddToEntity() {
        ...
        if  !(self.entity?.node is SKScene) {
            ...
            OctopusKit.logForTips ("Use RelayComponent(for:) to add a relay to the scene's sharedKeyboardEventComponent, or override the scene's input handling methods.")
        }
    }
