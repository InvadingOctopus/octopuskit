...
public final class KeyboardEventComponent: OKComponent, RequiresUpdatesPerFrame {
    ...
    public override func didAddToEntity() {
        ...
        if  !(self.entity?.node is SKScene) {
            ...
            OKLog.logForTips.debug("\(📜("Use RelayComponent(for:) to add a relay to the scene's sharedKeyboardEventComponent, or override the scene's input handling methods."))")
        }
    }
