...
//    }
    ...
    public override func didAddToEntity() {
        ...
        if  !(self.entity?.node is SKScene) {
            ...
            OKLog.logForTips.debug("\(📜("Use RelayComponent(for:) to add a relay to the scene's sharedPointerEventComponent, or override the scene's input handling methods."))")
        }
    }
