...
public final class PointerControlledPhysicsDraggingComponent: OctopusComponent, OctopusUpdatableComponent {
    ...
    public override func didAddToEntity(withNode node: SKNode) {
        ...
        if  node is SKScene {
            OctopusKit.logForWarnings.add("A PointerControlledPhysicsDraggingComponent cannot be added to the scene entity — Removing.")
