...
- **Vitamin 2D**: At the moment, OK is primarily a framework for 2D games, but it does not prevent you from using 3D technologies like SceneKit, and it can be used for non-game apps.
